...
// TODO: version
func MakeBlock(maker []byte, height INT, chainID string, alltxs []Tx, commit *CommitCache,
	prevBlockID pbtypes.BlockID, valHash, appHash, receiptsHash []byte, partSize, nonEmptyHeight INT) (*BlockCache, *PartSet) {
	extxs := []Tx{}
	txs := []Tx{}
