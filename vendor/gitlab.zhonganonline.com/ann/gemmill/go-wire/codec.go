...
func BasicCodecEncoder(o interface{}, w io.Writer, n *int, err *error) {
	switch o := o.(type) {
	case nil:
		gcmn.PanicSanity("nil type unsupported")
	case byte:
	...
	case time.Time:
		...
		WriteTime(o, w, n, err)
	default:
		gcmn.PanicSanity(fmt.Sprintf("Unsupported type: %v", reflect.TypeOf(o)))
	}
}
...
func BasicCodecDecoder(r io.Reader, n *int, err *error) (o interface{}) {
	...
	case typeTime:
		o = ReadTime(r, n, err)
	default:
		*err = errors.New(gcmn.Fmt("Unsupported type byte: %X", type_))
	}
	return
}
...
func BasicCodecComparator(o1 interface{}, o2 interface{}) int {
	...
	default:
		gcmn.PanicSanity(gcmn.Fmt("Unsupported type: %v", reflect.TypeOf(o1)))
	}
	return 0
}
